...
fn main() {
    ...
    phf_codegen::Map::new()
        ...
        .entry("Archetypes.Ball.Ball_Trajectory", "SpawnTrajectory::LocationAndRotation")
    ...
    phf_codegen::Map::new()
        ...
        .entry("Engine.PlayerReplicationInfo:bTimedOut", "AttributeTag::Boolean")
        ...
        .entry("TAGame.CameraSettingsActor_TA:bMouseCameraToggleEnabled", "AttributeTag::Boolean")
        .entry("TAGame.CameraSettingsActor_TA:bUsingSecondaryCamera", "AttributeTag::Boolean")
        .entry("TAGame.CameraSettingsActor_TA:bUsingSwivel", "AttributeTag::Boolean")
    ...
    phf_codegen::Map::new()
        ...
        .entry("Archetypes.Ball.Ball_Trajectory", "\"TAGame.Ball_TA\"")
