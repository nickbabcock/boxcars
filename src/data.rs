...
pub(crate) static SPAWN_STATS: phf::Map<&'static str, SpawnTrajectory> = phf::phf_map! {
    ...
    "Archetypes.KnockOut.GameEvent_Knockout:CarArchetype.Jump" => SpawnTrajectory::Location,
    "Archetypes.KnockOut.GameEvent_Knockout:CarArchetype.DoubleJump" => SpawnTrajectory::Location,
    "Archetypes.KnockOut.GameEvent_Knockout:CarArchetype.Dodge" => SpawnTrajectory::Location,
    "Archetypes.KnockOut.GameEvent_Knockout:CarArchetype.Torque" => SpawnTrajectory::Location,
    "Archetypes.KnockOut.GameEvent_Knockout:CarArchetype.StunlockArchetype" => SpawnTrajectory::Location,
    "Archetypes.KnockOut.GameEvent_Knockout:CarArchetype.Flip" => SpawnTrajectory::Location,
    "Archetypes.KnockOut.GameEvent_Knockout:CarArchetype.Boost" => SpawnTrajectory::Location,
    "Archetypes.KnockOut.GameEvent_Knockout:CarArchetype" => SpawnTrajectory::LocationAndRotation,
    ...
    "Archetypes.Teams.TeamWhite0" => SpawnTrajectory::Location,
    "Archetypes.Teams.TeamWhite1" => SpawnTrajectory::Location,
};
...
pub(crate) static OBJECT_CLASSES: &[(&str, &str)] = &[
