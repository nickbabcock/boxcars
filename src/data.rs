...
pub(crate) static ATTRIBUTES: phf::Map<&'static str, AttributeTag> = phf::phf_map! {
    ...
    "Engine.Actor:RelativeRotation" => AttributeTag::RotationTag,
...
pub(crate) static PARENT_CLASSES: phf::Map<&'static str, &'static str> = phf::phf_map! {
    ...
    "GameInfo_SnowDayTerritory.GameInfo.GameInfo_SnowDayTerritory:Archetype" => "TAGame.GameEvent_Soccar_TA",
    ...
    "GameInfo_Territory.GameInfo.GameInfo_Territory:Archetype" => "TAGame.GameEvent_Soccar_TA",
