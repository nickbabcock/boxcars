...
mod tests {
    ...
    #[test]
    fn test_b0867_replay() {
        let data = include_bytes!("../assets/b0867.replay");
        let mut parser = Parser::new(&data[..], CrcCheck::Always, NetworkParse::Always);
        match parser.parse() {
    ...
    #[test]
    fn test_e4598_replay() {
        let data = include_bytes!("../assets/e4598.replay");
        let mut parser = Parser::new(&data[..], CrcCheck::Always, NetworkParse::Always);
        match parser.parse() {
            Ok(replay) => assert_eq!(replay.network_frames.unwrap().frames.len(), 6898),
            Err(ref e) => panic!(format!("{}", e)),
        }
    }
    ...
    #[test]
    fn test_7083_replay() {
        let data = include_bytes!("../assets/7083.replay");
        let mut parser = Parser::new(&data[..], CrcCheck::Always, NetworkParse::Always);
        match parser.parse() {
    ...
    #[test]
    fn test_16d5_replay() {
        let data = include_bytes!("../assets/16d5.replay");
        let mut parser = Parser::new(&data[..], CrcCheck::Always, NetworkParse::Always);
        match parser.parse() {
            Ok(replay) => assert_eq!(replay.network_frames.unwrap().frames.len(), 405),
            Err(ref e) => panic!(format!("{}", e)),
        }
    }
    ...
    #[test]
    fn test_551c_replay() {
        let data = include_bytes!("../assets/551c.replay");
        let mut parser = Parser::new(&data[..], CrcCheck::Always, NetworkParse::Always);
        match parser.parse() {
